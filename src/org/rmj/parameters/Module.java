...
public class Module implements GRecord{   
    ...
    public UnitModule newRecord() {
        ...
        loObject.setModuleCd(MiscUtil.getNextCode(loObject.getTable(), "sModuleCd", false, loConn, psBranchCd));
    ...
    public UnitModule saveRecord(Object foEntity, String fsTransNox) {
        ...
        if (fsTransNox.equals("")){
            ...
            loNewEnt.setModuleCd(MiscUtil.getNextCode(loNewEnt.getTable(), "sModuleCd", false, loConn, psBranchCd));
    ...
    public boolean deactivateRecord(String fsTransNox) {
        ...
        if (loObject.getRecdStat().equalsIgnoreCase(RecordStatus.INACTIVE)){
        ...
        String lsSQL = "UPDATE " + loObject.getTable() + 
                        ...
                        " WHERE sModuleCd = " + SQLUtil.toSQL(loObject.getModuleCd());
    ...
    public boolean activateRecord(String fsTransNox) {
        ...
        if (loObject.getRecdStat().equalsIgnoreCase(RecordStatus.ACTIVE)){
